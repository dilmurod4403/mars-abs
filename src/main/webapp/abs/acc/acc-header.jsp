...
<div class="app-layout">
    ...
    <aside class="sidebar" id="sidebar">
        <a href="${__cp}/abs/acc/dashboard.jsp" class="sidebar-brand" style="text-decoration:none;">
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a class="nav-item ${param.page == 'dashboard' ? 'active' : ''}" href="${__cp}/abs/acc/dashboard.jsp">
            ...
            <div class="nav-section">
                ...
                <a class="nav-item ${param.page == 'approve' ? 'active' : ''}" href="${__cp}/abs/acc/account-approve.jsp">
            ...
            <div class="nav-section">
                ...
                <a class="nav-item ${param.page == 'currency-stats' ? 'active' : ''}" href="${__cp}/abs/acc/currency-stats.jsp">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                    Valyuta statistikasi
                </a>
                <a class="nav-item ${param.page == 'dormant' ? 'active' : ''}" href="${__cp}/abs/acc/dormant-accounts.jsp">
    ...
    <div class="app-main">
        ...
        <header class="topbar">
            ...
            <div class="topbar-search">
                ...
                <input type="text" placeholder="Hisob raqami, mijoz bo'yicha qidirish..." aria-label="Qidirish">
            </div>
